...
-- CreateIndex
CREATE UNIQUE INDEX "candidates_telephone_key" ON "candidates"("telephone");

-- CreateIndex
CREATE INDEX "candidates_names_email_telephone_idx" ON "candidates"("names", "email", "telephone");
